...
const Budget =({dataTables}) => {
  ...
  const [transactions, setTransactions] = useState(0); // changed to 0 from null and TypeError went away
  const [sumTrans, setSumTrans] = useState(0); // changed to 0 from null and TypeError went away
  // set last 30 days;
